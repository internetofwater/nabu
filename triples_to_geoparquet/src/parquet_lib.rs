...
use arrow_schema::{DataType::{LargeUtf8, Utf8}, Field, Schema, SchemaBuilder};
...
pub fn generate_schema() -> Schema {
    ...
    // let feature_name = Field::new("feature_name", LargeUtf8, true);
    // schema_builder.push(feature_name);

    // let feature_description = Field::new("feature_description", LargeUtf8, true);
