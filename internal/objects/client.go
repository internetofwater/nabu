...
func (m *MinioClientWrapper) Remove(v1 *viper.Viper, bucket, object string) error {
...
func (m *MinioClientWrapper) Copy(v1 *viper.Viper, srcbucket, srcobject, dstbucket, dstobject string) error {
