...
class ShaclValidator(shacl_validator_pb2_grpc.ShaclValidatorServicer):
    """Implementation of the ShaclValidator service."""

    def validate(self, request, context):
        return validate_jsonld(request, format="location_oriented")
...
def main():
    ...
    parser.add_argument('--socket', type=str, default='/tmp/shacl_validator.sock',
